...
const routes = ["", "/servicos", "/auditoria", "/criar-site", "/explorar", "/videos", "/ia", "/automacoes", "/comunidades", "/marketplace", "/sites", "/barbearia-wayne", "/aprender", "/aprender/game-dev", "/jogos", "/planos", "/termos", "/privacidade"];
